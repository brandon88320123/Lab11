...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_query, btn_insert, btn_start, btn_update, btn_delete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_insert.setOnClickListener(view -> {
            if (ed_book.length() <1 || ed_price.length() <1)
                Toast.makeText(MainActivity.this, "蘭為請勿留空", Toast.LENGTH_SHORT).show();
            else{
                try{
        ...
        btn_update.setOnClickListener(view -> {
            if (ed_book.length() <1 || ed_price.length() <1)
                Toast.makeText(MainActivity.this, "欄為請勿留空", Toast.LENGTH_SHORT).show();
            else{
                try{
